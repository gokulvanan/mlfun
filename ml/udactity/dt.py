...
acc_min_samples_split_2 = accuracy_score(labels_test,clf_2.predict(features_test))
acc_min_samples_split_50 = accuracy_score(labels_test, clf_50.predict(features_test))
